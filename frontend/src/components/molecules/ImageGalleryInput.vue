...
<template>
  ...
  >
    ...
    <div
      v-else
      class="flex items-center justify-center pointer-events-auto z-10 h-full"
    >
      <span
        class="button group-hover:bg-accent group-hover:border-accent-foreground"
