...
ALTER TABLE "er_builds_rels" ADD COLUMN "er_sorceries_id" integer;
ALTER TABLE "er_builds_rels" ADD COLUMN "er_incantations_id" integer;
DO $$ BEGIN
...
ALTER TABLE "er_builds_rels" DROP COLUMN IF EXISTS "er_sorceries_id";
ALTER TABLE "er_builds_rels" DROP COLUMN IF EXISTS "er_incantations_id";`);
