import type { ErBuild, ErAmmunition, ErArmor, ErAshesOfWar, ErClass, ErIncantation, ErShield, ErSorcery, ErTalisman, ErWeapon } from '@payload-types'
...
export function createRandomBuild(): ErBuild {
  return {
    ...
    images: createRandomLengthArrayOfObject('image', 5),
    ...
    offhand_weapons: createRandomLengthArrayOfObject('weapon', 100),
    armors: createRandomLengthIntArray(200),
    talismans: createRandomLengthIntArray(50),
    arrows: createRandomLengthIntArray(23),
    bolts: createRandomLengthIntArray(23),
    incantations: createRandomLengthIntArray(50),
    sorceries: createRandomLengthIntArray(40),
